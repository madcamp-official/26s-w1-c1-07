/**
 * 게임9 · 줄다리기 (Tug of War) — NEON COIN-OP 화면. 담당: game9 에이전트.
 * 컨테이너 testid: scr-game9 / 부품: game-stage(CRT 베젤), hud-*(HudFrame 내장), btn-exit
 *
 * ── 원칙 ────────────────────────────────────────────────────────────
 *  · 로직/판정은 100% @madpump/shared game9 코어(create/step)로만 구동.
 ...
 *  라운드마다 game9.create(Math.random) → rAF 루프에서 game9.step(state, events, dt초)
  ...
  return (
    <main data-testid="scr-game9" className="g9-screen">
      ...
      <div className="g9-topbar">
        ...
        <span className="g9-title font-arcade c-muted">게임9 · 줄다리기</span>
      </div>
      ...
      <div data-testid="game-stage" className={`crt-bezel g9-stage ${urgent ? 'urgent' : ''}`}>
        <canvas ref={canvasRef} className="g9-canvas" aria-label="게임9 스테이지 — 줄다리기" />
        ...
        {flow.phase === 'playing' && flow.currentRound > 0 && (
          <div key={flow.currentRound} className="g9-round-intro" aria-hidden>
            ...
            <span className="font-arcade c-muted g9-round-intro__sub">ALT-MASH TO PULL!</span>
          </div>
        )}
      </div>
      ...
      {isOnline ? (
        <div className="g9-keys g9-keys--online">
          ...
          <span className="g9-keys__hint font-arcade c-muted">U↔I 교대 연타!</span>
        </div>
      ) : (
        <div className="g9-keys">
          <div className="g9-keys__group">
            ...
            <span className="g9-keys__tag font-arcade c-p1">P1 · 번갈아 당기기</span>
          </div>
          <span className="g9-keys__hint font-arcade c-muted">Q↔W · U↔I 교대 연타!</span>
          <div className="g9-keys__group">
            <span className="g9-keys__tag font-arcade c-p2">P2 · 번갈아 당기기</span>
