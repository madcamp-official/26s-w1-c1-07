 ...
 * SPEC QA-S2-01~09. 리더보드 = @shared computeLeaderboard(내 분반 mock 유저 + 나, mockMatches, scoreConfig).
 *   분반에 mock 데이터가 없으면 빈 상태 정직 표기(§0.4) — LeaderboardTable의 NO RECORD.
 */
import { useMemo } from 'react';
import { useNavigate } from 'react-router-dom';
import { computeLeaderboard, mockGroups, mockMatches, mockUsers, scoreConfig } from '@shared';
import type { MockUser } from '@shared';
